...
const (
	jsonLDContext = "https://raw.githubusercontent.com/Tribes-Dapp/identity/main/utils/schema/KYC_Tribes_Creator/KYC_Tribes_Creator.jsonld"                                                 // JSONLD schema for credential
	typ           = "tribesIdentityCreator"                 // credential type
	fieldName     = "majority"                              // field name in form of field.field2.field3 field must be present in the credential subject
	schemaJSONLD  = `{
		"@context": [
			{
				"@protected": true,
